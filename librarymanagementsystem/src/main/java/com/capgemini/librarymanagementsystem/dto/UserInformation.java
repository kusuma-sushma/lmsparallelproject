...
public class UserInformation implements Serializable {
	...
	public String toString() {
		return "UserInformation [userId=" + userId + ", username=" + username + ", password=" + password + ", email="
				+ email + ", department=" + department + ", noOfBooksBorrowed=" + noOfBooksBorrowed + ", fine=" + fine
				+ "]";
	}
