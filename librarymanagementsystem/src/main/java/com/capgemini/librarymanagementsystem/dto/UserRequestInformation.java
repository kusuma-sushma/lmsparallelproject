...
public class UserRequestInformation implements Serializable {
	...
	public UserRequestInformation(int bookId, int userId, Date dateOfIssued, Date dateOfReturn, Date actualReturnDate,
			boolean bookIssued, boolean bookReturned) {
		super();
		this.bookId = bookId;
		this.userId = userId;
	...
	public String toString() {
		return "UserRequestInformation [bookId=" + bookId + ", userId=" + userId + ", dateOfIssued=" + dateOfIssued
				+ ", dateOfReturn=" + dateOfReturn + ", actualReturnDate=" + actualReturnDate + ", bookIssued="
				+ bookIssued + ", bookReturned=" + bookReturned + "]";
	}
