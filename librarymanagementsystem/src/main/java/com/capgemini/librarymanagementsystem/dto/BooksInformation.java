...
public class BooksInformation implements Serializable {
	...
	public String toString() {
		return "BooksInformation [bookId=" + bookId + ", bookName=" + bookName + ", bookCategory=" + bookCategory
				+ ", bookAuthor=" + bookAuthor + ", bookPublisher=" + bookPublisher + ", bookAvailable=" + bookAvailable
